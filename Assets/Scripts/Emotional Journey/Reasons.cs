...
public class Reasons : MonoBehaviour {
    ...
    void FoundMatch(Collider2D[] colliders, int i) {
        ...
        newPoints.transform.localPosition = new Vector3(-220, 110, 0);
    ...
    public void Initialize(string newReason, int newID) {
        reason = newReason;
        id = newID;
    }
    ...
    public void SetText() {
        this.GetComponentInChildren<Text>().text = reason;
    }
